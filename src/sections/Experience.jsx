const experiences = [
  {
    ...
    description:
      "Developed profitable websites and modern full-stack apps, solving practical problems and growing through real-world development experience.",
    technologies: ["React", "TypeScript", "Node.js", "Express.js", "MongoDB"],
    current: true,
  },
  {
    period: "2025",
    role: "Bachelor’s Degree in Electrical Engineering & Computer Science",
    company: "Faculty of Technical Sciences, University of Novi Sad",
    description:
      "Graduated from the Faculty of Technical Sciences, University of Novi Sad, with a strong foundation in software engineering and problem solving.",
  ...
  },
  {
    ...
    description:
      "Developed algorithm for ranking and selecting Distributed Energy Resources (DERs)  using C++ based on multi-criteria decision-making principles.",
